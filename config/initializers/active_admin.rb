...
# Injeta a auth do super_admin no controller base do ActiveAdmin (que herda de
# ActionController::Base, onde o Devise já injeta current_user/authenticate_user!).
Rails.application.config.to_prepare do
  ActiveAdmin::BaseController.include(SuperAdminAuthentication)
end
