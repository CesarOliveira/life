...
- [ ] **Fase 3b — Import de PDF de exame**: upload do PDF + extração automática (visão/LLM) → cria `measurements` (categoria exam, com faixa de referência). Requer `ANTHROPIC_API_KEY` no ambiente; degrada com aviso se ausente.
